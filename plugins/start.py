    ...
    if FORCE_SUB:
        try:
          ...
          if str(user.status) == "ChatMemberStatus.BANNED":
              await message.reply_text("You are Banned. Contact -- 𝙼𝚁 𝚁𝙰𝙹𝙿𝚄𝚃")
              return 1
            ...
            await message.reply_text(f"Something Went Wrong. Contact admins... with following message {𝙼𝚁 𝚁𝙰𝙹𝙿𝚄𝚃}")
            return 1 
...
async def terms(client, message):
    ...
    buttons = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("💬 Contact Now", url="https://t.me/rajput681830")],
        ]
    )
